...
std::vector<std::vector<double>> MatrixUtil::product(const std::vector<std::vector<double>> &m1,
...
std::vector<std::vector<double>> MatrixUtil::transpose(const std::vector<std::vector<double>> &mat)
{
    if (mat.size() == 0)
    {
...
std::vector<std::vector<double>> MatrixUtil::inverse(const std::vector<std::vector<double>> &mat)
{

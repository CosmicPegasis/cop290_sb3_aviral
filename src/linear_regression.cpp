...
double LinearRegressionCore::dot_product(const std::vector<double> &v1, const std::vector<double> &v2)
{
    if (v1.size() != v2.size())
...
std::vector<double> LinearRegressionCore::calculte_theta()
{
...
LinearRegressionCore::LinearRegressionCore(const std::vector<std::vector<double>> &x, const std::vector<double> &y)
    : x_vec{x}, y_vec{y}
{
    if (x.size() != y.size())
...
LinearRegressionCore::LinearRegressionCore(){};

double LinearRegressionCore::predict(const std::vector<double> &x)
{
    if (this->trained)
    {
...
std::vector<double> LinearRegressionCore::get_theta()
{
    if (this->trained)
    {
        return theta;
...
std::vector<std::vector<double>> LinearRegression::get_transformed(const std::vector<std::vector<double>> &x)
{
...
void LinearRegression::initialise_core(const std::vector<std::vector<double>> &x, const std::vector<double> &y)
{
...
std::vector<double> LinearRegression::get_predictions(const std::vector<std::vector<double>> &x)
{
...
Statistics LinearRegression::get_stats(std::vector<double> predicted_prices, std::vector<double> close_prices, int p,
                                       int x)
{
    return Statistics{};
};
void LinearRegression::parse_args(std::vector<std::string> args)
{
...
Statistics LinearRegression::get_stats(std::vector<double> &predicted_prices, std::vector<double> &close_price,
...
LinearRegression::LinearRegression(std::vector<std::string> args)
{
...
LinearRegression::LinearRegression(std::string symbol, int x, int p, std::string start, std::string end)
